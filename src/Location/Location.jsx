...
const Location = () => {
  ...
  const venueMapUrl = branding?.venueMapUrl || clientConfig?.venueMapUrl || "";
  const venueMapEmbedUrl = branding?.venueMapEmbedUrl || clientConfig?.venueMapEmbedUrl || "https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d26061.10405075751!2d33.23597854371439!3d35.07057250264388!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f22!3m3!1m2!1s0x151f17f5032467cb%3A0x326c9386a712963a!2sYarzeh%20officers%20club!5e0!3m2!1sen!2s!4v1771197779659!5m2!1sen!2s";

  const handleGetDirections = () => {
    if (venueMapUrl) {
      window.open(venueMapUrl, "_blank");
    } else {
      const venueAddress = branding?.venueAddress || clientConfig?.venueAddress || "Officers Club Yarze";
